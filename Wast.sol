...
contract Wast is IERC20, Ownable {
    ...
    uint256 private _totalSupply = 2100000000000000000000000000000;
    uint256 private _currentSupply = 2100000000000000000000000000000;
    ///////////////////////////////620014500000000000000000000000
    ...
    uint256 private numTokensSellToAddToLiquidity = 10500 * 10**12 * 10**12;
    ...
    constructor (address routerAddress, address payable marketingAddress)  {
        ...
        _allowances[address(this)][address(uniswapV2Router)] = 2100000000000000000000000000000;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        if(_whiteListed[sender] || _whiteListed[recipient]){
            ...
            _balances[sender] -= amount;
            _balances[recipient] += amount - applyFee(sender, amount, 1, 3, 3, 3);
        }
    }
